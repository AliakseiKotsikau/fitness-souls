...
export const {worldDeathButtonClick, bossDeathButtonClick, wheelSpinned, limitOfExercisesReached, changeCurrentBoss, addRepsToExercise, setInitialData, bossBeaten, gameChanged} = fitnessSoulsSlice.actions
